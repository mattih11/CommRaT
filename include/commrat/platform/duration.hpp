/**
 * @file duration.hpp
 * @brief Platform-independent Duration type for CommRaT
 * 
...
public:
    ...
    /// Zero duration (replaces Milliseconds::zero() pattern)
...
// ============================================================================
// Free Function Constructors (replace old using-declaration type aliases)
// 
// These are constexpr functions, NOT types.
// Usage: Milliseconds(100) returns a Duration with 100ms.
// Compatible with Period<Milliseconds(100)> NTTP pattern.
// ============================================================================
